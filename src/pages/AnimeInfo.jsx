    ...
    <div className="flex justify-between bg-[#616164] text-white m-20">
      ...
      <div className="m-8">
        ...
        <div className="flex justify-start">
          ...
          <p className="bg-green-400 border rounded-r border-black  px-2 text-black">
        ...
        <div className="mt-10">
          <Link to={`/watch-anime/${info?.id}`}>
            <button className="mr-5 bg-[#ffdd95] px-4 py-2 border border-[#ffdd95] rounded-full text-black ">
              Watch Now
            </button>
          </Link>
        </div>
